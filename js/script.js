...
// Question 1
document.getElementById("host-name").textContent = "Tommy";
document.getElementById('collaborator-name').textContent = "Kostas Hatzopoulos"


// Question 2
// You can also create their own CSS classes in style.css file and use that. 
let floatingButton = document.getElementById("instruction_button");
floatingButton.addEventListener("click", hideInstructions);

function hideInstructions() {
    console.log(this);
    // get all instructions
    let setOfQuestions = document.querySelectorAll(".questions");
